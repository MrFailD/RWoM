...
namespace TorannMagic 
{
    internal class GenStep_MagicAdventureGenerator : GenStep
    {
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            adventureRegion = new CellRect(num, num3, num2, num4);
            ...
            baseResolveParams = default(ResolveParams);
            foreach (string current in randomRoomEvents.Keys)
            {
                baseResolveParams.SetCustom<float>(current, randomRoomEvents[current], false);
            }
        }
    }
}
