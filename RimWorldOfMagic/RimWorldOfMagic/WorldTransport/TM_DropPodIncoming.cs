    ...
    public class TM_DropPodIncoming : Skyfaller, IActiveTransporter, IThingHolder
    {
        ...
        protected override void SpawnThings()
        {
            ...
            else
            {
                ...
                {
                    GenSpawn.Spawn(innerContainer[num], Position, Map, Contents.spawnWipeMode.Value);
                }
            }
        }
        ...
        public void DrawLightBeam()
        {
            ...
            Vector3 drawPos = Position.ToVector3Shifted() + angleVector;
            ...
            matrix2.SetTRS(Position.ToVector3Shifted() + Vector3Utility.FromAngleFlat(angle + 90) * .5f * lanceWidth, Quaternion.Euler(0f, angle, 0f), new Vector3(lanceWidth, 1f, lanceWidth));                 //drawer for beam start
