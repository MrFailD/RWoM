...
namespace TorannMagic
{
    ...
    public static class TM_RenderQueue
    {
        ...
        public static readonly Material whiteShieldMat = MaterialPool.MatFrom("Other/Shield", ShaderDatabase.Transparent, whiteShieldColor);
        public static readonly Material redShieldMat = MaterialPool.MatFrom("Other/Shield", ShaderDatabase.Transparent, redShieldColor);

        public static readonly Color burningFuryColor = new Color(1f, .4f, .25f);
        public static readonly Material burningFuryMat = MaterialPool.MatFrom("Other/Shield", ShaderDatabase.Transparent, burningFuryColor);

        public static readonly Color manaShieldColor = new Color(127f, 0f, 255f);
        public static readonly Material manaShieldMat = MaterialPool.MatFrom("Other/Shield", ShaderDatabase.Transparent, manaShieldColor);

        public static readonly Color demonShieldColor = new Color(150f, 0f, 75f);
        public static readonly Material demonShieldMat = MaterialPool.MatFrom("Other/Shield", ShaderDatabase.Transparent, demonShieldColor);
        ...
        public static readonly Material arcanistMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, arcanistMarkColor);
        public static readonly Color necroMarkColor = new Color(.4f, .5f, .25f);
        public static readonly Material necroMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, necroMarkColor);
        public static readonly Color summonerMarkColor = new Color(.8f, .4f, .0f);
        public static readonly Material summonerMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, summonerMarkColor);
        ...
        public static readonly Material priestMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, priestMarkColor);
        public static readonly Color bardMarkColor = new Color(.8f, .8f, 0f);
        public static readonly Material bardMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, bardMarkColor);
        public static readonly Color demonkinMarkColor = new Color(.6f, 0, .25f);
        public static readonly Material demonkinMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, demonkinMarkColor);
        public static readonly Color earthMarkColor = new Color(.4f, .2f, 0f);
        public static readonly Material earthMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, earthMarkColor);
        public static readonly Color technoMarkColor = new Color(0, .8f, 0f);
        public static readonly Material technoMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, technoMarkColor);
        public static readonly Color enchanterMarkColor = new Color(1, .6f, .6f);
        public static readonly Material enchanterMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, enchanterMarkColor);
        public static readonly Color bloodmageMarkColor = new Color(0.6f, 0f, 0f);
        public static readonly Material bloodmageMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, bloodmageMarkColor);
        public static readonly Color chronomancerMarkColor = new Color(.4f, .65f, 1f);
        public static readonly Material chronomancerMarkMat = MaterialPool.MatFrom("Other/MageMark", ShaderDatabase.Transparent, chronomancerMarkColor);
        ...
        public static readonly Material facelessMarkMat = MaterialPool.MatFrom("Other/FighterMark", ShaderDatabase.Transparent, facelessMarkColor);
        public static readonly Color rangerMarkColor = new Color(.3f, .6f, .0f);
        public static readonly Material rangerMarkMat = MaterialPool.MatFrom("Other/FighterMark", ShaderDatabase.Transparent, rangerMarkColor);
        public static readonly Color gladiatorMarkColor = new Color(0f, .35f, .75f);
        public static readonly Material gladiatorMarkMat = MaterialPool.MatFrom("Other/FighterMark", ShaderDatabase.Transparent, gladiatorMarkColor);
        ...
        public static readonly Material sniperMarkMat = MaterialPool.MatFrom("Other/FighterMark", ShaderDatabase.Transparent, sniperMarkColor);
        public static readonly Color psionicMarkColor = new Color(0f, .5f, 1f);
        public static readonly Material psionicMarkMat = MaterialPool.MatFrom("Other/PsiMark", ShaderDatabase.Transparent, psionicMarkColor);
        public static readonly Color monkMarkColor = new Color(1f, 1f, 0f);
        public static readonly Material monkMarkMat = MaterialPool.MatFrom("Other/PsiMark", ShaderDatabase.Transparent, monkMarkColor);
        public static readonly Color deathknightMarkColor = new Color(.01f, .01f, .01f);
        public static readonly Material deathknightMarkMat = MaterialPool.MatFrom("Other/FighterMark", ShaderDatabase.Transparent, deathknightMarkColor);
