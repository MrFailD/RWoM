    ...
    public class Verb_SummonTotemLightning : Verb_UseAbility
    {
        ...
        protected override bool TryCastShot()
        {
            ...
            if (shiftPos != IntVec3.Invalid && (shiftPos.IsValid && shiftPos.Standable(map)))
            {
                ...
                try
                {
                    totem = TM_Action.SingleSpawnLoop(caster, tempPod, shiftPos, map, 2500 + (125 * verVal), true, false, caster.Faction, false);
                    totem.SetFaction(caster.Faction);
                    Building_TMTotem_Lightning totemBuilding = totem as Building_TMTotem_Lightning;
