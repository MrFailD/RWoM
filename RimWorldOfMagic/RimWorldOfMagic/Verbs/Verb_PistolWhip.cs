...
namespace TorannMagic
{
    ...
    public class Verb_PistolWhip : Verb_UseAbility
    {
        protected override bool TryCastShot()
        {
            ...
            if (caster != null && currentTarget != null && currentTarget.Thing != null && currentTarget.Thing is Pawn)
            { 
                ...
                DamageInfo dinfo = new DamageInfo(DamageDefOf.Stun, Mathf.RoundToInt(comp.weaponDamage * TorannMagicDefOf.TM_PistolWhip.weaponDamageFactor + ver.level), 4, (float)-1, CasterPawn, null, null, DamageInfo.SourceCategory.ThingOrUnknown);
