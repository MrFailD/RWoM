...
namespace TorannMagic
{
    ...
    public class Verb_EnchantmentAction : Verb_MeleeAttack
    {
        ...
        protected override DamageWorker.DamageResult ApplyMeleeDamageToTarget(LocalTargetInfo target)
        {
            ...
            DamageInfo dinfo = new DamageInfo(DamageDefOf.Cut, (int)(tool.power), 0, (float)-1, CasterPawn, null, null, DamageInfo.SourceCategory.ThingOrUnknown);
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                {
                    DamageInfo dinfo2 = new DamageInfo(TMDamageDefOf.DamageDefOf.TM_Cleave, (int)(tool.power * .6f), 0, (float)-1, CasterPawn, null, null, DamageInfo.SourceCategory.ThingOrUnknown);
