        ...
        protected override bool TryCastShot()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                flyingObject.AdvancedLaunch(CasterPawn, null, 0, Mathf.Clamp(Rand.Range(5, 80),
                    0, tmpTarget.Cell.DistanceToEdge(CasterPawn.Map)), false, CasterPawn.DrawPos, tmpTarget, launchedThing, Mathf.RoundToInt((Rand.Range(.8f, 1.2f) * verbProps.defaultProjectile.projectile.speed)), verbProps.defaultProjectile.projectile.explosionRadius > 0, Rand.Range(16, 24),
